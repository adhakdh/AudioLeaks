...
# Config
# =========================
split_modes_to_run = ["gamebehavior", "gamelevel", "keyboard", "vrchatroom", "smallroom"]
...
def process_one_input_dir(input_dir):
    ...
    output_dir = os.path.join(save_dir, os.path.basename(input_dir)+"_mel_npy")
...
def main():
    for split_mode in split_modes_to_run:
        input_dir = f"../../Datasets/otherattack/{split_mode}"
